...
void ofApp::loadPresets(ofxXmlSettings XML){
...
void ofApp::loadBanks(ofxXmlSettings XML){
...
void ofApp::loadParamAttribute(ofxXmlSettings XML, paramAttributes * p){
...
string ofApp::getModeString(e_mouseMode temp){
